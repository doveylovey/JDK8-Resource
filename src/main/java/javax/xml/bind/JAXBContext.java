...
public abstract class JAXBContext {
     ...
     *                    mapped classes
     * @param classLoader This class loader will be used to locate the implementation
     *                    classes.
...
//    }
     ...
     *                                  files generated at the development time.)
     *                                  </ol>
     * @throws IllegalArgumentException if the parameter contains {@code null} (i.e., {@code newInstance(null,someMap);})
     * @since JAXB2.0
     */
     ...
     * @throws UnsupportedOperationException if DOM API corresponding to <tt>domType</tt> is not supported by
     *                                       the implementation.
     * @since JAXB2.0
     */
     ...
     * @throws UnsupportedOperationException Calling this method on JAXB 1.0 implementations will throw
     ...
     *
     * @param outputResolver this object controls the output to which schemas
     *                       will be sent.
