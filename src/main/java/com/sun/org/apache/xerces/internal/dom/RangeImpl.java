...
public class RangeImpl implements Range {
     ...
     *
     * @param endAncestor The ancestor of the end container that is a direct child
     ...
     * <code>traverse</code> method.
     *
     * @param startAncestor The ancestor of the start container that is a direct
     ...
     *
     * @param startAncestor Given a common ancestor of the start and end containers,
     *                      this parameter is the ancestor (or self) of the start
     *                      container that is a direct child of the common ancestor.
     * @param endAncestor   Given a common ancestor of the start and end containers,
     ...
     * @param isFullySelected Set to true if the node is fully selected.  Should be
     *                        false otherwise.
