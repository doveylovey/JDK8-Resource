...
public class _DynArrayStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.DynamicAny.DynArray {
     ...
     *
     * @throws TypeMismatch if one or more elements have a type that is inconsistent with the DynArrays TypeCode
     * @throws InvalidValue if the sequence does not contain the same number of elements as the array dimension
     */
