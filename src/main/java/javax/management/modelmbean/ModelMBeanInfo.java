...
public interface ModelMBeanInfo {
     ...
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException when the descriptorType in parameter is
     ...
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException for a null or invalid descriptor.
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @see #getDescriptors
     */
     ...
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException for a null descriptor name or null or invalid type.
     ...
     * @throws MBeanException             Wraps a distributed communication
     *                                    Exception.
     * @throws RuntimeOperationsException a {@link
     ...
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException  for invalid descriptor.
     ...
     * if there is none.
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException for a null operation name.
     */
     ...
     * is none.
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException for a null notification name.
     */
