...
abstract public class ORB {
     ...
     * @throws WrongTransaction if the method <code>get_next_response</code>
     ...
     * @param original_type the <code>TypeCode</code> object describing the original type
     ...
     * @param element_type the <code>TypeCode</code> object describing the elements
