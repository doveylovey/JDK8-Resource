...
class Bits {                            // package-private
     ...
     *
     * @param src     the source array, must be a 16-bit primitive array type
     * @param srcPos  byte offset within source array of the first element to read
     * @param dstAddr destination address
     * @param length  number of bytes to copy
     */
     ...
     *
     * @param srcAddr source address
     * @param dst     destination array, must be a 16-bit primitive array type
     * @param dstPos  byte offset within the destination array of the first element to write
     * @param length  number of bytes to copy
     */
     ...
     *
     * @param src     the source array, must be a 32-bit primitive array type
     * @param srcPos  byte offset within source array of the first element to read
     * @param dstAddr destination address
     * @param length  number of bytes to copy
     */
     ...
     *
     * @param srcAddr source address
     * @param dst     destination array, must be a 32-bit primitive array type
     * @param dstPos  byte offset within the destination array of the first element to write
     * @param length  number of bytes to copy
     */
     ...
     *
     * @param src     the source array, must be a 64-bit primitive array type
     * @param srcPos  byte offset within source array of the first element to read
     * @param dstAddr destination address
     * @param length  number of bytes to copy
     */
     ...
     *
     * @param srcAddr source address
     * @param dst     destination array, must be a 64-bit primitive array type
     * @param dstPos  byte offset within the destination array of the first element to write
     * @param length  number of bytes to copy
     */
