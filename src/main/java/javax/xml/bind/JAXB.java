...
public final class JAXB {
     ...
     * Reads in a Java object tree from the given XML input.
     *
     * @param xml The URI is {@link URI#toURL() turned into URL} and then
     ...
     * Reads in a Java object tree from the given XML input.
     *
     * @param xml The string is first interpreted as an absolute <tt>URI</tt>.
     ...
     * Reads in a Java object tree from the given XML input.
     *
     * @param xml The XML infoset that the {@link Source} represents is read.
     */
     ...
     *
     * @param jaxbObject The Java object to be marshalled into XML. If this object is
     ...
     * @param xml        XML will be written to this file. If it already exists,
     ...
     *                   {@link Class#getSimpleName() the short class name}.
     *                   This parameter must not be null.
     * @param xml        The XML will be {@link URLConnection#getOutputStream() sent} to the
     ...
     *                   {@link Class#getSimpleName() the short class name}.
     *                   This parameter must not be null.
     * @param xml        The XML will be sent to the given {@link OutputStream}.
     *                   Upon a successful completion, the stream will be closed by this method.
     * @throws DataBindingException If the operation fails, such as due to I/O error, unbindable classes.
     */
     ...
     *                   {@link Class#getSimpleName() the short class name}.
     *                   This parameter must not be null.
     * @param xml        The XML will be sent as a character stream to the given {@link Writer}.
     *                   Upon a successful completion, the stream will be closed by this method.
     * @throws DataBindingException If the operation fails, such as due to I/O error, unbindable classes.
     */
     ...
     *                   {@link Class#getSimpleName() the short class name}.
     *                   This parameter must not be null.
     * @param xml        Represents the receiver of XML. Objects of the following types are allowed.
     *
     *                   <table><tr>
     *                   <th>Type</th>
     *                   <th>Operation</th>
