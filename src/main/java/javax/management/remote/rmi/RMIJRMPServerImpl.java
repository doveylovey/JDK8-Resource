...
public class RMIJRMPServerImpl extends RMIServerImpl {
     ...
     * @throws IOException              if the {@link RMIServer} object
     *                                  cannot be created.
     * @throws IllegalArgumentException if <code>port</code> is
     *                                  negative.
     */
     ...
     * @throws IOException if the stub cannot be obtained - e.g the
     ...
     * @throws IOException if the new {@link RMIConnection}
