...
// end of NPCTE fix for bugId 4499265
     ...
     * @throws SnmpStatusException if the index cannot be built from the
     *                             given OID.
     **/
     ...
     * @throws SnmpStatusException if the given index is not valid.
     **/
     ...
     * @throws SnmpStatusException if the entry cannot be registered with
     *                             the given index.
     **/
     ...
     *              interface.
     * @throws SnmpStatusException if the entry cannot be unregistered.
     **/
