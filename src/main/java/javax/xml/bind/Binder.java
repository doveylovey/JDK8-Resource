...
public abstract class Binder<XmlNode> {
     ...
     *
     * @param xmlNode the document/element to unmarshal XML data from.
     ...
     * @throws UnmarshalException       If the {@link ValidationEventHandler ValidationEventHandler}
     ...
     * @return <a href="JAXBElement.html">JAXB Element</a> representation
     * of <tt>node</tt>
     * @throws JAXBException            If any unexpected errors occur while unmarshalling
     * @throws UnmarshalException       If the {@link ValidationEventHandler ValidationEventHandler}
     *                                  returns false from its <tt>handleEvent</tt> method or the
     ...
     * @throws MarshalException         If the {@link ValidationEventHandler ValidationEventHandler}
     *                                  returns false from its <tt>handleEvent</tt> method or the
     ...
     * XML element.
     * @throws IllegalArgumentException If the jaxbObject parameter is null
     */
     ...
     * associated XML elements.
     *
     * @return null if the specified XML node is not known to this
     ...
     * @return Returns the updated XML node. Typically, this is the same
     ...
     * XML nodes and JAXB objects.
     *
     * @return Returns the updated JAXB object. Typically, this is the same
