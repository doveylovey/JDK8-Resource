...
public final class AttributeSetUtilities {
     ...
     * @throws ClassCastException   (unchecked exception) Thrown if <CODE>object</CODE> is not a
     ...
     * @throws IllegalArgumentException (unchecked exception) Thrown if the <CODE>category</CODE> is not
