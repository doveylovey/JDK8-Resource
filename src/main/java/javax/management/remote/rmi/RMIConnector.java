...
public class RMIConnector implements JMXConnector, Serializable, JMXAddressable {
     ...
     * @throws IllegalArgumentException if <code>rmiServer</code>
     *                                  is null.
     */
     ...
     * @throws IOException              if the connection to the ORB failed.
     **/
     ...
     *                                  <tt>java.naming.corba.orb</tt> property is specified and
     *                                  does not point to an {@link org.omg.CORBA.ORB ORB}.
     * @throws IOException              if the ORB initialization failed.
     **/
     ...
     * @throws InvalidObjectException if none of <var>rmiServer</var> stub
     ...
     * @throws NamingException if the stub couldn't be found.
     **/
